...
/**
 * Test case for class \DSACharManager\ScDsacharmanager\Domain\Model\FrontendUser.
 *
...
class FrontendUserTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \DSACharManager\ScDsacharmanager\Domain\Model\FrontendUser
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \DSACharManager\ScDsacharmanager\Domain\Model\FrontendUser();
	}
