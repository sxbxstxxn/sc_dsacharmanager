...
/**
 * Test case for class \DSACharManager\ScDsacharmanager\Domain\Model\FEUser.
 *
...
class FEUserTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \DSACharManager\ScDsacharmanager\Domain\Model\FEUser
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \DSACharManager\ScDsacharmanager\Domain\Model\FEUser();
	}
